...
<body>
	...
	<table class="table">
		...
		<tr>
			<td>Place Birthday</td>
			<td><?php echo $place_birthday; ?></td>
		</tr>
		<tr>
			<td>Joindate</td>
		...
		<tr>
			<td>Hospitalized</td>
			<td><?php echo $hospitalized; ?></td>
		</tr>
		<tr>
			<td>Medicalcond</td>
			<td><?php echo $medicalcond; ?></td>
		</tr>
		<tr>
			<td>Shoes</td>
		...
		<tr>
			<td>Medicaltestnotes</td>
			<td><?php echo $medicaltestnotes; ?></td>
		</tr>
		<tr>
			<td>Pants</td>
		...
		<tr>
			<td>Is Vnpf</td>
			<td><?php echo $is_vnpf; ?></td>
		</tr>
		<tr>
			<td>Is Emp</td>
			<td><?php echo $is_emp; ?></td>
		</tr>
		<tr>
			<td>Bankid</td>
		...
		<tr>
			<td></td>
			<td><a href="<?php echo site_url('emp_info') ?>" class="btn btn-default">Cancel</a></td>
		</tr>
	</table>
</body>
