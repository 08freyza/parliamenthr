			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Emp_family_relationship</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>Emp_family_relationship</span></a></li>
	    		...
	    		<div class="form-group">
					...
					<input type="text" class="form-control" name="name" id="name" placeholder="Name"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $name; ?>" />
														...
														<a href="<?php echo site_url('familysetup') ?>" class="btn btn-default">Cancel</a>
														</form>
												</div>
											</div>
										</div>
