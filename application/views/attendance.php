									...
									<div class="col-sm-12 col-xs-12">
										...
										<div class="form-wrap">
											<form method="post">
												...
												<div class="form-group">
													<div class="pr-10 pull-left" style="cursor:pointer;">
                                        				<input TYPE="Radio" Name="type" Value="cIn" style="cursor:pointer;">&nbsp;Check In</input>
                                        			</div>
                                        			<div class="pr-10 pull-left" style="cursor:pointer;">
                                        				<input TYPE="Radio" Name="type" Value="lIn" style="cursor:pointer;">&nbsp;Lunch In</input>
                                        			</div>
                                        			<div class="pr-10 pull-left" style="cursor:pointer;">
                                        				<input TYPE="Radio" Name="type" Value="lOut" style="cursor:pointer;">&nbsp;Lunch Out</input>
                                        			</div>
                                        			<div class="pr-10 pull-left" style="cursor:pointer;">
                                        				<input TYPE="Radio" Name="type" Value="cOut" style="cursor:pointer;">&nbsp;Check Out</input>
													</div>
													<div class="clearfix"></div>
												</div>
												<div class="form-group text-center">
													<button type="submit" class="btn btn-info btn-rounded">Submit</button>&nbsp;
													<button type="button" class="btn btn-info btn-rounded" onclick="window.location.href='<?=base_url();?>'">System Login</button>
												</div>
											</form>
										</div>
									</div>	
