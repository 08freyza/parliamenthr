		...
		<div class="page-wrapper">
			<div class="container-fluid">
				<div class="row heading-bg" style="margin-bottom: 10px">
					<div class="col-md-4">
						<h2 style="margin-top:0px">Policy List</h2>
					</div>
					...
					<div class="col-md-4 text-right">
						<?php echo anchor(site_url('policy/create'), 'Create', 'class="btn btn-primary"'); ?>
						<?php echo anchor(site_url('policy/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    			</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var t = $("#mytable").dataTable({
				...
				paging:   false,
				serverSide: true,
				ajax: {"url": "policy/json", "type": "POST"},
				columns: [
					{
						"data": "id",
						"orderable": false
