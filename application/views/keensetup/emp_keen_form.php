			...
			<div class="page-wrapper">
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>Emp_keen</span></a></li>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Emp_keen Form</h6>
									</div>
	    		...
	    		<div class="form-group">
					...
					<input type="text" class="form-control" name="title" id="title" placeholder="Title"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $title; ?>" />
														...
														<a href="<?php echo site_url('keensetup') ?>" class="btn btn-default">Cancel</a>
														</form>
												</div>
											</div>
										</div>
