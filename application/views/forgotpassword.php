                    ...
                    <div class="auth-form ml-auto mr-auto no-float">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="mb-20">
                                    <h4 class="text-center txt-dark">Forgot Password</h4>
                                </div>
                                <div class="form-wrap">
                                    <form method="post">
                                        <div class="form-group">
                                            <label class="control-label mb-10" for="exampleInputEmail_2">Email address</label>
                                            <input type="email" class="form-control" name="email" required="" id="exampleInputEmail_2" placeholder="Enter email address">
                                        </div>
                                        <div class="form-group text-center">
                                            <button type="submit" class="btn btn-info btn-rounded" style="margin-top: 10px;">send to email</button>&nbsp;
                                        </div>
                                        <div class="form-group text-center sign-in-box">
                                            Remember your password? <a class="sign-in-link" href="<?= base_url() ?>login">Sign in here!</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
