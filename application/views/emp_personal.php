	...
	<link href="<?=base_url();?>assets/dist/css/style.css" rel="stylesheet" type="text/css">
		...
		<div class="page-wrapper">
									...
									<div class="profile-box">
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<img class="inline-block mb-10" src="<?=base_url();?>assets/dist/img/mock1.jpg" alt="user"/>
												<div class="fileupload btn btn-default">
													<span class="btn-text">edit</span>
													<input class="upload" type="file">
												</div>
																...
																<a href="javascript:void(0)">
																	...
																	<div class="sl-content">
																		...
																		<div class="activity-thumbnail">
																			<img src="<?=base_url();?>assets/dist/img/thumb-1.jpg" alt="thumbnail"/>
																			<img src="<?=base_url();?>assets/dist/img/thumb-2.jpg" alt="thumbnail"/>
																			<img src="<?=base_url();?>assets/dist/img/thumb-3.jpg" alt="thumbnail"/>
																		</div>
													...
													<div class="gallery-wrap">
														<div class="portfolio-wrap project-gallery">
															<ul id="portfolio_1" class="portf auto-construct  project-gallery" data-col="4">
																<li  class="item"   data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock1.jpg" data-sub-html="<h6>Bagwati</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>" >
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock1.jpg"  alt="Image description" />
																	<span class="hover-cap">Bagwati</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock2.jpg"   data-sub-html="<h6>Not a Keyboard</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock2.jpg"  alt="Image description" />
																	<span class="hover-cap">Not a Keyboard</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock3.jpg" data-sub-html="<h6>Into the Woods</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock3.jpg"  alt="Image description" />
																	<span class="hover-cap">Into the Woods</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock4.jpg"  data-sub-html="<h6>Ultra Saffire</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock4.jpg"  alt="Image description" />
																	<span class="hover-cap"> Ultra Saffire</span>
																	</a>
																</li>
																
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock5.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock5.jpg"  alt="Image description" />	
																	<span class="hover-cap">Happy Puppy</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock6.jpg"  data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock6.jpg"  alt="Image description" />
																	<span class="hover-cap">Wooden Closet</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock7.jpg" data-sub-html="<h6>Happy Puppy</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock7.jpg"  alt="Image description" />	
																	<span class="hover-cap">Happy Puppy</span>
																	</a>
																</li>
																<li class="item" data-src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock8.jpg"  data-sub-html="<h6>Wooden Closet</h6><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
																	<a href="">
																	<img class="img-responsive" src="<?=base_url();?>assets/dist/img/gallery/equal-size/mock8.jpg"  alt="Image description" />
																	<span class="hover-cap">Wooden Closet</span>
																	</a>
																</li>
															</ul>
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2017 &copy; Vanuatu HR Governmant. Provided by CNS</p>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
	...
	<script src="<?=base_url();?>assets/dist/js/skills-counter-data.js"></script>
    ...
    <script src="<?=base_url();?>assets/dist/js/morris-data.js"></script>
	...
	<!-- Gallery JavaScript -->
	<script src="<?=base_url();?>assets/dist/js/isotope.js"></script>
	<script src="<?=base_url();?>assets/dist/js/lightgallery-all.js"></script>
	<script src="<?=base_url();?>assets/dist/js/froogaloop2.min.js"></script>
	<script src="<?=base_url();?>assets/dist/js/gallery-data.js"></script>
	
	<!-- Spectragram JavaScript -->
	<script src="<?=base_url();?>assets/dist/js/spectragram.min.js"></script>
	
	<!-- Init JavaScript -->
	<script src="<?=base_url();?>assets/dist/js/init.js"></script>
	<script src="<?=base_url();?>assets/dist/js/widgets-data.js"></script>