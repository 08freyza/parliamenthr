			...
			<div class="page-wrapper">
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>Parliament Setup</span></a></li>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Parliament Setup Form</h6>
									</div>
	    		...
	    		<div class="form-group">
					...
					<input type="text" class="form-control" name="name" id="name" placeholder="Name"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $name; ?>" />
														...
														<a href="<?php echo site_url('ministrysetup') ?>" class="btn btn-default">Cancel</a>
														</form>
												</div>
											</div>
										</div>
