			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">VW_EMP_LEAVE</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>VW_EMP_LEAVE</span></a></li>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">VW_EMP_LEAVE Form</h6>
									</div>
	    		...
	    		<div class="form-group">
					<label for="bigint">Id <?php echo form_error('id') ?></label>
					<input type="text" class="form-control" name="id" id="id" placeholder="Id"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $id; ?>" />
				</div>
	    		<div class="form-group">
	    		...
	    		<div class="form-group">
					<label for="char">Leave Type <?php echo form_error('leave_type') ?></label>
	    		...
	    		<div class="form-group">
					...
					<input type="text" class="form-control" name="director_approved_date" id="director_approved_date" placeholder="Director Approved Date"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $director_approved_date; ?>" />
														...
														<a href="<?php echo site_url('vw_emp_leavex') ?>" class="btn btn-default">Cancel</a>
														</form>
												</div>
											</div>
										</div>
