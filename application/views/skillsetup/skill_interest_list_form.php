			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Skill_interest_list</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>Skill_interest_list</span></a></li>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Skill_interest_list Form</h6>
									</div>
	    		...
	    		<div class="form-group">
					...
					<input type="text" class="form-control" name="type" id="type" placeholder="Type"  <?php if ($button == 'Read') echo 'disabled=disabled';?> value="<?php echo $type; ?>" />
														...
														<a href="<?php echo site_url('skillsetup') ?>" class="btn btn-default">Cancel</a>
														</form>
												</div>
											</div>
										</div>
