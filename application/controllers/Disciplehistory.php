...
class Disciplehistory extends CI_Controller
{
    ...
    {
        $this->template->general('disciplehistory/emp_disciple_list');
    }
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->template->general('disciplehistory/emp_disciple_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('disciplehistory'));
        }
    }
    ...
    public function create()
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('disciplehistory/create_action'),
            'id' => set_value('id'),
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('disciplehistory/update_action'),
...
/* End of file Disciplehistory.php */
/* Location: ./application/controllers/Disciplehistory.php */
