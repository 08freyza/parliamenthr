...
class Emp_info extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->general('emp_info/employee_list');
	}
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->template->general('emp_info/employee_form', $data);
		} else {
			$this->session->set_flashdata('message', 'Record Not Found');
			redirect(site_url('emp_info'));
		}
	}
	...
	public function create_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array(
				...
				'salary_grade' => $this->input->post('salary_grade', TRUE),
				...
				'island' => $this->input->post('island', TRUE),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('emp_info/update_action'),
				...
				'salary_grade' => set_value('salary_grade', $row->salary_grade),
				...
				'island' => set_value('island', $row->island),
	...
	$this->form_validation->set_rules('joindate', 'joindate', 'trim|required');*/
		...
		$this->form_validation->set_rules('qualifications', 'religion', 'trim|required');
		/*$this->form_validation->set_rules('location', 'location', 'trim|required');
	$this->form_validation->set_rules('unit', 'unit', 'trim|required');
	$this->form_validation->set_rules('title', 'title', 'trim|required');
	$this->form_validation->set_rules('grade', 'grade', 'trim|required');*/
		$this->form_validation->set_rules('salary_grade', 'salary grade', 'trim|required');
	...
	function _getNextEmpNo()
	{
		$ret = $this->Employee_model->getLastEmpNo();
		if ($ret->num_rows() > 0) {
			$out = $ret->row()->emp_no;
			$out = (((int)(substr($out, 3))) + 1);
			return 'EMP' . substr('000000' . $out, -6);
		}
	}
}

/* End of file Emp_info.php */
/* Location: ./application/controllers/Emp_info.php */
