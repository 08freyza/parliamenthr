...
class Myaward extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Myaward_model');
    ...
    {
        $this->template->general('myaward/emp_award_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Myaward_model->json();
    }

    public function read($id) 
    {
        $row = $this->Myaward_model->get_by_id($id);
        if ($row) {
            $data = array(
				'button' => 'Read',
				'action' => 'read',
		...
		'remark' => $row->remark,
            ...
            $this->template->general('myaward/emp_award_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('myaward'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('myaward/create_action'),
	    'id' => set_value('id'),
    ...
    public function create_action() 
    {
		...
		'remark' => $this->input->post('remark',TRUE),
            ...
            $this->Myaward_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('myaward/update_action'),
    ...
    public function update_action() 
    {
		...
		'remark' => $this->input->post('remark',TRUE),
            ...
            $this->Myaward_model->update($this->input->post('id', TRUE), $data);
...
/* End of file Myaward.php */
/* Location: ./application/controllers/Myaward.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-01-07 09:27:27 */
/* http://harviacode.com */